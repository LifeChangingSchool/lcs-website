...
export default function Interest() {
    ...
    return (
        <main className="lcs-container">
            ...
            <p className="content aside max-w-2xl mx-auto text-xs sm:text-base">If you made an account already, <Link href="/apply"><a>login to the portal here.</a></Link> Do not create an account if you haven't already — fill out the form below for access to the application.</p>
